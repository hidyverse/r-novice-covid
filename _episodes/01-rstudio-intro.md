...
object `x` that we created earlier contains 1, 2, 3, 4, 5:
...
> > {: .language-r}
> >
> > This will multiply the existing value of 47.5 by 2.3 to give
> > a new value of 109.25 to the variable mass.
> >
> > 
> > ~~~
> > age <- age - 20
...
> > {: .language-r}
> >
> > This will subtract 20 from the existing value of 122 to
> > give a new value of 102 to the variable age. {: .solution} {:
> > .challenge}
