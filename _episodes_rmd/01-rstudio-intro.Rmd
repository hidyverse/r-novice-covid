...
collected data, analysis begins! This lesson will teach you how to
start the data analysis process using R and RStudio. 

This workshop uses a dataset from
[The University of Arizona Test-Trace-Treat program](https://covid19.arizona.edu/test-trace-treat) containing COVID-19 test results for individuals across campus. 
